...
new WPUpdatesThemeUpdater_2299( 'http://wp-updates.com/api/2/theme', basename(get_template_directory()) );
*/

#if( !class_exists('WPThemeUpdateClass') ) {
	class WPThemeUpdate {
		...
		function check_for_update( $transient ) {
			file_put_contents(__DIR__.'/transient.log', print_r($transient, true));
